...
# (date, entity, segment, note_text, author)
_NOTES = [
    # --- benign history noise ---
    (dt.date(2024, 4, 15), "ALL", "ALL",
    ...
    # --- fallout cause ---
    (dt.date(2024, 5, 9), "ERCOT Coast", "Door_to_Door",
    ...
    # --- new-entity launch context (first-run series) ---
...
def generate(config) -> pd.DataFrame:
    ...
    rows = [
        ...
        for (d, entity, segment, note_text, author) in _NOTES
    ]
